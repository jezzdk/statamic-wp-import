...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Importer.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Importer.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    startImport: function startImport() {
      ...
      fetch(cp_url('wp-import/import'), {
        ...
        if (response.ok) {
          ...
          _this.importError = response.statusText + ' (' + response.status + ')';
        }

        _this.$progress.complete('wp-import');
    ...
    duplicateCount: function duplicateCount(items) {
      var count = 0;

      lodash__WEBPACK_IMPORTED_MODULE_0___default().each(items, function (item) {
        if (!item.exists) {
          return;
        }
    ...
    uncheckDuplicates: function uncheckDuplicates(items) {
      lodash__WEBPACK_IMPORTED_MODULE_0___default().each(items, function (item) {
        if (!item.exists) {
          return;
        }
    ...
    size: function size(obj) {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default().size(obj);
    },
    showCollection: function showCollection(collection) {
      this.showCollections.push(collection);

      lodash__WEBPACK_IMPORTED_MODULE_0___default().uniq(this.showCollections);
    },
    hideCollection: function hideCollection(hidden) {
      this.showCollections = lodash__WEBPACK_IMPORTED_MODULE_0___default().reject(this.showCollections, function (c) {
        return c === hidden;
      });
    },
    shouldShowCollection: function shouldShowCollection(collection) {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default().includes(this.showCollections, collection);
    },
    showTaxonomy: function showTaxonomy(taxonomy) {
      this.showTaxonomies.push(taxonomy);

      lodash__WEBPACK_IMPORTED_MODULE_0___default().uniq(this.showTaxonomies);
    },
    hideTaxonomy: function hideTaxonomy(hidden) {
      this.showTaxonomies = lodash__WEBPACK_IMPORTED_MODULE_0___default().reject(this.showTaxonomies, function (t) {
        return t === hidden;
      });
    },
    shouldShowTaxonomy: function shouldShowTaxonomy(taxonomy) {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default().includes(this.showTaxonomies, taxonomy);
    },
    showGlobal: function showGlobal(global) {
      this.showGlobals.push(global);

      lodash__WEBPACK_IMPORTED_MODULE_0___default().uniq(this.showGlobals);
    },
    hideGlobal: function hideGlobal(hidden) {
      this.showGlobals = lodash__WEBPACK_IMPORTED_MODULE_0___default().reject(this.showGlobals, function (g) {
        return g === hidden;
      });
    },
    shouldShowGlobal: function shouldShowGlobal(global) {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default().includes(this.showGlobals, global);
    },
    calculateTotalEntries: function calculateTotalEntries() {
      ...
      if (this.summary.pages) {
        Object.keys(this.summary.pages).forEach(function (key) {
          if (_this2.summary.pages[key]['_checked']) {
            totalEntries++;
          }
        });
      }
      ...
      if (this.summary.collections) {
        Object.keys(this.summary.collections).forEach(function (key) {
          Object.keys(_this2.summary.collections[key]['entries']).forEach(function (entry) {
            if (_this2.summary.collections[key]['entries'][entry]['_checked']) {
              totalEntries++;
            }
          });
        });
      ...
      if (this.summary.taxonomies) {
        Object.keys(this.summary.taxonomies).forEach(function (key) {
          Object.keys(_this2.summary.taxonomies[key]['terms']).forEach(function (entry) {
            if (_this2.summary.taxonomies[key]['terms'][entry]['_checked']) {
              totalEntries++;
            }
          });
        });
...
Statamic.booting(function () {
  Statamic.$components.register('wp-importer', _components_Importer_vue__WEBPACK_IMPORTED_MODULE_0__.default);
});
})();
